package com.example.photooftheday.recycler
...
class RecyclerActivityAdapter(
    ...
    private lateinit var binding: ActivityRecyclerItemMarsBinding
    ...
    override fun onBindViewHolder(
        ...
        if (payloads.isEmpty())
            ...
            if (newData.first.someText != oldData.first.someText) {
                binding.marsTextView.text = newData.first.someText
            }
        }
    }
    ...
    inner class EarthViewHolder(view: View) : BaseViewHolder(view) {
        private lateinit var binding: ActivityRecyclerItemEarthBinding
    ...
    inner class MarsViewHolder(view: View) : BaseViewHolder(view), ItemTouchHelperViewHolder {
        private lateinit var binding: ActivityRecyclerItemMarsBinding
        override fun bind(dataItem: Pair<Data, Boolean>) {
            binding.marsImageView.setOnClickListener { onListItemClickListener.onItemClick(dataItem.first) }
